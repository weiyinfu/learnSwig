 ...
 */
 bytertc::IRtcEngine* CreateRtcEngine(const char* app_id,
 ...
 */
 bytertc::IRtcEngine* CreateGameRtcEngine(const char* app_id,
        bytertc::IRtcEngineEventHandler* event_handler, const char* parameters);
 ...
 *          通知应用程序引擎运行时的事件。IRtcEngineEventHandler{@link #IRtcEngineEventHandler} 中定义的所有方法都是可选实现的。
 */
 bytertc::IRtcEngine* CreateRtcEngineWithPtr(
 ...
 *          通知应用程序引擎运行时的事件。IRtcEngineEventHandler{@link #IRtcEngineEventHandler} 中定义的所有方法都是可选实现的。
 */
 bytertc::IRtcEngine* CreateGameRtcEngineWithPtr(
        const char* app_id, std::unique_ptr<bytertc::IRtcEngineEventHandler> event_handler,
        const char* parameters);
 ...
 */
 void DestroyRtcEngine(bytertc::IRtcEngine* engine);
 ...
 *          造成死锁。
 */
 void DestroyGameRtcEngine(bytertc::IRtcEngine* engine);
