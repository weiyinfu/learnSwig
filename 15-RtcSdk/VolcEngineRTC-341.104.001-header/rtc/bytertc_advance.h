 ...
 */
 void SetAppState(IRtcEngine* engine, const char* appState);
 ...
 *      false：设置失败
 */
 bool SetHardWareEncodeContext(jobject j_egl_context);
 ...
 */
 void ClearHardWareEncodeContext();
 ...
 */
 void SetApplicationContext(jobject j_application_context);
#endif
 ...
 */
 IHWDeviceContext* CreateHwDeviceContext(HWDeviceType device_type);
 ...
 */
 void SetVideoSourceHWDeviceContext(IRtcEngine* engine, IHWDeviceContext* hw_context);
 ...
 */
 IVideoFrame* BuildVideoFrame(const VideoFrameBuilder& builder);
 ...
 *      2.该函数运行在用户调用线程内
 */
 bool PushExternalVideoFrame(IRtcEngine* engine, const IVideoFrame* frame);
 ...
 * @hidden
 */
 IAudioFrame* BuildAudioFrame(const AudioFrameBuilder& builder);
 ...
 * @hidden
 */
 IEncodedAudioFrame* CreateEncodedAudioFrame();

/**
 * @hidden
 */
 IEncodedVideoFrame* BuildEncodedVideoFrame(const EncodedVideoFrameBuilder& builder);
 ...
 */
 void RegisterRemoteEncodedAudioFrameObserver(IRtcEngine* engine, IRemoteEncodedAudioFrameObserver* observer);
 ...
 *       + 将参数设置为 nullptr 则取消注册。
 */
 void RegisterLocalEncodedAudioFrameObserver(IRtcEngine* engine, ILocalEncodedAudioFrameObserver* observer);


/**
 * @hidden
 */
 bool PushExternalEncodedAudioFrame(IRtcEngine* engine, const IEncodedAudioFrame* audio_stream);
 ...
 * @type api
 */
 void SetupEngineMediaIo(IRtcEngine* engine, const MediaIoOption& option);
 ...
 * @return 音频设备管理接口
 */
 IAudioDeviceManagerEx* CreateAudioDeviceManager(IAudioDeviceEventHandler* handler);
